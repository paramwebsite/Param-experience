...
const icons = [
  {
    icon: "https://digital-applications-assets.sgp1.cdn.digitaloceanspaces.com/digitalassestbucket/paramscience/footer/icons/Instagram.svg",
    redirectUrl: "https://www.instagram.com/paraminnovation/",
  },
  {
    icon: "https://digital-applications-assets.sgp1.cdn.digitaloceanspaces.com/digitalassestbucket/paramscience/footer/icons/Facebook.svg",
    redirectUrl: "https://www.facebook.com/paraminnovation/",
  },
  {
    icon: "https://digital-applications-assets.sgp1.cdn.digitaloceanspaces.com/digitalassestbucket/paramscience/footer/icons/X.svg",
    redirectUrl: "https://twitter.com/paraminnovation",
  },
  {
    icon: "https://digital-applications-assets.sgp1.cdn.digitaloceanspaces.com/digitalassestbucket/paramscience/footer/icons/YouTube.svg",
    redirectUrl: "https://youtube.com/@ParamScienceExperience?feature=shared",
  },
  {
    icon: "https://digital-applications-assets.sgp1.cdn.digitaloceanspaces.com/digitalassestbucket/paramscience/footer/icons/WhatsApp.svg",
              ...
              <div className="linksAndContact">
                ...
                <div className="contactUs">
                  ...
                  <p className="marketingEmail">
                    <img
                      src="https://digital-applications-assets.sgp1.cdn.digitaloceanspaces.com/digitalassestbucket/paramscience/footer/icons/mail.svg"
                      alt=""
                    />{" "}
                  ...
                  <p className="contactNo">
                    <img
                      src="https://digital-applications-assets.sgp1.cdn.digitaloceanspaces.com/digitalassestbucket/paramscience/footer/icons/contact.svg"
                      alt=""
                    />{" "}
                    +91 73385 80197
                  </p>
