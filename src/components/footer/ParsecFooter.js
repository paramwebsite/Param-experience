              ...
              <div className="linksAndContact">
                ...
                <div className="contactUs">
                  ...
                  <p className="marketingEmail">
                    <img
                      src="https://digital-applications-assets.sgp1.digitaloceanspaces.com/digitalassetsbucket/paramscience/footer/icons/mail.svg"
                      alt=""
                    />{" "}
                  ...
                  <p className="contactNo">
                    <img
                      src="https://digital-applications-assets.sgp1.digitaloceanspaces.com/digitalassetsbucket/paramscience/footer/icons/contact.svg"
                      alt=""
                    />{" "}
                    +91 73385 80197
                  </p>
